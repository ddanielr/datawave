...
public class QueryIteratorIT extends EasyMockSupport {
    ...
    public void setup() throws IOException {
        ...
        EasyMock.expect(iterEnv.getTableId()).andReturn(fakeId).anyTimes();
        EasyMock.expect(pluginEnv.getConfiguration()).andReturn(PluginEnvironment.Configuration.from(Map.of(), true)).anyTimes();
        EasyMock.expect(pluginEnv.getConfiguration(fakeId)).andReturn(PluginEnvironment.Configuration.from(Map.of(), true)).anyTimes();
